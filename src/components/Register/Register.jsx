  ...
  return (
    <>
      ...
      <form onSubmit={formik.handleSubmit} className="max-w-md h-screen flex flex-col items-center justify-center mx-auto ">
        <p className='pb-14 text-2xl font-semibold'> Register</p>
